...
TDialog* createFindDialog()
{
    ...
    d->insert(new TCheckBoxes(
        TRect(3, 5, 35, 7), new TSItem("~C~ase sensitive", new TSItem("~W~hole words only", 0))));
...
EditorApp::EditorApp(int argc, char** argv)
    : TProgInit(EditorApp::initStatusLine, EditorApp::initMenuBar, EditorApp::initDeskTop)
    , TApplication()
{
    TCommandSet ts;
    ts.enableCmd(cmSave);
