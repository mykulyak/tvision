...
TStreamableClass RStringCollection(
    TStringCollection::name, TStringCollection::build, __DELTA(TStringCollection));
...
TStreamable* TStringCollection::build() { return new TStringCollection(streamableInit); }
