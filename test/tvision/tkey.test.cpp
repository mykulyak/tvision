...
TEST(TKey, ShouldConstructProperly)
{
    static constexpr TestCase<KeyCodeAndMods> testCases[] = {
        ...
        { { 'A', kbShift | kbCtrlShift | kbAltShift },
            { 'A', kbShift | kbCtrlShift | kbAltShift } },
        { { 'a' }, { 'A' } },
        { { 'a', kbShift }, { 'A', kbShift } },
        { { 'a', kbCtrlShift }, { 'A', kbCtrlShift } },
        ...
        { { '0', kbShift | kbCtrlShift | kbAltShift },
            { '0', kbShift | kbCtrlShift | kbAltShift } },
        { { kbA }, { 'A' } },
        ...
        { { kbA, kbShift | kbCtrlShift | kbAltShift },
            { 'A', kbShift | kbCtrlShift | kbAltShift } },
        { { kb0 }, { '0' } },
        ...
        { { kb0, kbShift | kbCtrlShift | kbAltShift },
            { '0', kbShift | kbCtrlShift | kbAltShift } },
        ...
        { { kbTab, kbShift | kbCtrlShift | kbAltShift },
            { kbTab, kbShift | kbCtrlShift | kbAltShift } },
